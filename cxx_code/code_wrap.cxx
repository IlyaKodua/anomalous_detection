...
SWIGINTERN PyObject *_wrap_AUC(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "AUC", 2, 2, swig_obj)) SWIG_fail;
  {
    std::vector< float,std::allocator< float > > *ptr = (std::vector< float,std::allocator< float > > *)0;
    int res = swig::asptr(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "AUC" "', argument " "1"" of type '" "std::vector< float,std::allocator< float > >""'"); 
    }
    arg1 = *ptr;
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "AUC" "', argument " "2"" of type '" "std::vector< float,std::allocator< float > >""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = (float)AUC(arg1,arg2);
  resultobj = SWIG_From_float(static_cast< float >(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "AUC", _wrap_AUC, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
